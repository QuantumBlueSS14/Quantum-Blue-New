...
public sealed class MapMigrationSystem : EntitySystem
{
    ...
    private static readonly string[] MigrationFiles = { "/migration.yml", "/migration_imp.yml", "/migration_qb.yml" }; // Imp: use array of migration files QB: piggybacking off this to have our own
