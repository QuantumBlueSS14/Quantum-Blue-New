<p align="center"> <img alt="QuantumBlue" src="https://github.com/QuantumBlueSS14/Quantum-Blue-New/blob/master/Resources/Textures/Logo/logo.png" /></p>

Quantum Blue is a fork of Space Station 14, a remake of SS13 that runs on [Robust Toolbox](https://github.com/space-wizards/RobustToolbox), a homegrown engine written in C#.

While we are not a server that allows sexual content, <b>we do not allow people under the age of 18 to play on Quantum Blue.</b>

## Links
[Website](https://quantumblue.gay/) | [Steam](https://store.steampowered.com/app/1255460/Space_Station_14/) | [Standalone Download](https://spacestation14.io/about/nightlies/)
...
We are happy to accept contributions from anybody. Get in Discord if you want to help. We've got a [list of issues](https://github.com/QuantumBlueSS14/Quantum-Blue-New/issues) that need to be done and anybody can pick them up. Don't be afraid to ask for help either!
